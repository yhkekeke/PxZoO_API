...
try {
    ...
    WHERE sta_id LIKE :searchTerm OR sta_id LIKE :searchTerm OR sta_pos LIKE :searchTerm OR sta_email LIKE :searchTerm OR sta_acc LIKE :searchTerm OR sta_psw LIKE :searchTerm ";
    // 修改為您的 SQL 查詢
