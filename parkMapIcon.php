...
try {
    ...
    // 準備 SQL 查詢語句
    $sql = "SELECT l.category_name, l.location_name, a.animal_species, a.animal_name, a.animal_icon,a.animal_small_pic FROM location l LEFT JOIN animal a ON l.animal_id = a.animal_id";
